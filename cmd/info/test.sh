...
#
# example usage: 
# $GOPATH/src/github.com/clive2000/rclone/cmd/info/test.sh --list | \
#   parallel -P20 $GOPATH/src/github.com/clive2000/rclone/cmd/info/test.sh

export PATH=$GOPATH/src/github.com/clive2000/rclone:$PATH

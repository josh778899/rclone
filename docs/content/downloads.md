...
You can also find a [mirror of the downloads on GitHub](https://github.com/clive2000/rclone/releases/tag/{{< version >}}).
...
[git log](https://github.com/clive2000/rclone/commits/master).  The most
